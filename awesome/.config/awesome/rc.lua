...
-- Create and register wibox with batwidget
...
globalkeys = gears.table.join(
	...
	-- awful.key({ modkey }, "b", awful.spawn("firefox-developer-edition"), { description = "launch the default browser" }),
...
awful.rules.rules = {
	...
	-- Set Discord to always open on screen 1, tag 9
